...
def cv_score(clf, X, y, sample_weight=None, scoring='neg_log_loss',
             n_splits=(4, 2), t1=None, cv_gen=None, pct_embargo=0., purging=True,
             return_combs=False, num_threads=1, **kwargs):
    ...
    for train, test in cv_gen.split(X=X):
        ...
        # Scoring
        score_ = evaluate(clf_fit, X.iloc[test, :].values, y.iloc[test].values, scoring,
                          **test_params)
